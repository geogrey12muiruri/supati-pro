...
// Utility for dynamic width scaling
...
// Font size utilities based on screen width
...
// Expo StatusBar for managing appearance
export const AppStatusBar = ({ style = "auto" }: { style?: "auto" | "inverted" | "light" | "dark" }) => (
